...
function MyMap({defaultLoc={},setAddressLoading,getMapData}) {
    ...
    return (
        <>
            <Button onClick={handleOpen}><MapIcon/></Button>
            <Modal
                open={open}
                onClose={handleClose}
            ...
            >
                <Box sx={style}>
                    ...
                    <div className='d-flex align-items-center justify-content-center pb-3'>
                        <Button variant="contained" onClick={sendMapData}>{t('ثبت موقعیت')}</Button>
                    </div>
                </Box>
            </Modal>
